...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('as6809.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('as6809.wasm', import.meta.url).href;
}
...
var _usage = Module['_usage'] = makeInvalidEarlyAccess('_usage');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_usage'] = _usage = createExportWrapper('usage', 1);
